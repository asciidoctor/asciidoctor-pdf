 ...
 ** once we fix nested keep_together blocks, we'll need to use advance_page instead of start_new_page
* nested keep_together blocks are broken; perhaps because we are using the same scratch document?
...
* FILE ISSUE: ttfunk 1.5.0 chokes on narrow no-break space char \u202f
