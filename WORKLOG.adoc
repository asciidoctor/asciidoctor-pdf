...
* make room for large numbers in ordered list (workaround is to set a larger outline_list_indent in theme)
...
* description list term should keep together with content
* GhostScript Tiger SVG is reporting incorrect height when embedded; bug in prawn-svg?
...
* do CMYK values work for colors?
