= Roles
:description: Assign built-in and custom roles to inline phrases and paragraphs.

You can apply the built-in roles Asciidoctor PDF provides as well as custom roles you define in your theme to inline phrases and paragraphs.

== Use a built-in role

The following built-in roles can be assigned to inline phrases and paragraphs:
...
Now, you can use it in your documents.
In the following example, the custom role is assigned to a paragraph and an inline phrase.
