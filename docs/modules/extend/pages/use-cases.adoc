...
Therefore, as written, this converter requires you to use the fallback font (i.e., `-a pdf-theme=default-with-font-fallbacks`) unless your theme uses a custom font that supports this character.
