...
* This script author's description: https://shumpei-tanaka.github.io/en/posts/2024-11-23-asciidoc-page-border-in-margin/
...
[,ruby]
----
include::example$/pdf-converter-border-hole-page.rb[tags=**]
----
