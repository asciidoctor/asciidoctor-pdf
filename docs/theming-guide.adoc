...
In addition to the generic caption category, each of these keys can be set on the caption key nested inside the following block categories: blockquote, code (applies to listeral, listing, and blocks), example, footnotes, image, table, and verse.
