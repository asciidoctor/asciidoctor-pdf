...
. Activates line break rules for CJK languages.
Languages like Chinese and Japanese are written without spaces (and may not use spaces when mixing with English words).
A line break can occur between any two CJK characters.
