...
3+|[#key-prefix-admonition-icon]*Key Prefix:* <<key-prefix-admonition-icon,admonition_icon_<name> >>^[1]^

|name
|<icon set>-<icon name>^[2]^ +
(default: _not set_)
|admonition:
  icon:
    tip:
...
3+|[#key-prefix-toc-title]*Key Prefix:* <<key-prefix-toc-title,toc_title>>^[2]^
