...
* bring appearance of footnotes and footnote labels in line with common style guidelines (include brackets around footnote label in link; use bold footnote number with trailing period as footnote list marker) (#2297)
...
* prevent footnote label from wrapping (#2297)
