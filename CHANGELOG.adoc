...
* respect hide-uri-scheme when appending URL to link text when media is print or prepress (#2583)

Compliance::

* drop support for JRuby 9.2 (require at least Ruby 2.7 compliance)
