...
* Clear the placeholder text used for an anchor to fix CannotFit error in table cell (#447)
* Size the line number gutter correctly (accounting for width of largest line number) (#402)
* Allow theme to specify default value for pdfwidth attribute on image (#455)
...
* Start title page, toc, and main content on recto page when media=prepress and doctype=book
...
* Upgrade prawn-icon to 1.1.1
* Upgrade prawn-svg to 0.25.2 (by way of looser version range)
* Fix Ruby warnings
