...
If you want to use the prepress or compress PDF options you will need to install the `rghost` gem, e.g.:

  $ gem install rghost
  
(Or use `gem install --user-install rghost` if the above gives an access error.)
