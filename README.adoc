...
IMPORTANT: If you are creating a PDF for an online publisher, like KDP, you probably need to optimize it. If you don't, as Amazon says, remove all the transparencies and flatten it, it may fail to process your upload.
