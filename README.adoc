...
*Footnotes cannot be displayed at the bottom of the page because the PDF generator does not support content reflows.*
...
IMPORTANT: If you're creating a PDF for Amazon's Kindle Direct Publishing (KDP), and perhaps other online publishers, you likely need to optimize the file before uploading.
In their words, you must https://kdp.amazon.com/en_US/help/topic/G201953020#check[flatten all transparencies^] (mostly likely referring to images).
If you don't do this step, the platform may reject your upload.
